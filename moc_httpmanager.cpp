...
QT_MOC_LITERAL(8, 74, 22), // "ImageDownloadedHandler"
QT_MOC_LITERAL(9, 97, 14), // "QNetworkReply*"
QT_MOC_LITERAL(10, 112, 5), // "reply"
QT_MOC_LITERAL(11, 118, 25) // "WeatherDownloadedHandeler"

    },
    "HTTPManager\0ImageReady\0\0QPixmap*\0image\0"
    "WeatherJsonReady\0QJsonObject*\0json\0"
    "ImageDownloadedHandler\0QNetworkReply*\0"
    "reply\0WeatherDownloadedHandeler"
};
...
void HTTPManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->ImageDownloadedHandler((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 3: _t->WeatherDownloadedHandeler((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
